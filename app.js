...
const Router = {
  ...
  go(page) {
    ...
    if (target) {
      ...
      history.pushState({}, '', `#${page}`); // history.pushState ka upyog kiya gaya hai
...
// Mock catalog data
const PLANTS = [
  { id: 1, name: 'Snake Plant', price: 399, img: 'https://images.unsplash.com/photo-1545249390-6bdfa286032f?q=80&w=800&auto=format&fit=crop' },
  { id: 2, name: 'Monstera', price: 799, img: 'https://images.unsplash.com/photo-1545249390-6bdfa286032f?q=80&w=800&auto=format&fit=crop' },
  { id: 3, name: 'Areca Palm', price: 699, img: 'https://images.unsplash.com/photo-1545249390-6bdfa286032f?q=80&w=800&auto=format&fit=crop' },
  { id: 4, name: 'Aloe Vera', price: 299, img: 'https://images.unsplash.com/photo-1545249390-6bdfa286032f?q=80&w=800&auto=format&fit=crop' },
  { id: 5, name: 'ZZ Plant', price: 599, img: 'https://images.unsplash.com/photo-1545249390-6bdfa286032f?q=80&w=800&auto=format&fit=crop' },
